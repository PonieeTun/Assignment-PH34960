                        ...
                        <div class="col-4">
                            <div class="rounded-circle position-relative">
                                <div class="overflow-hidden rounded-circle">
                                    <img src="{{ asset('client/img/features-sports-1.jpg') }}"
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="row g-4 align-items-center features-item">
                        <div class="col-4">
                            <div class="rounded-circle position-relative">
                                <div class="overflow-hidden rounded-circle">
                                    <img src="{{ asset('client/img/features-technology.jpg') }}"
                                        class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                </div>
                                <span
                                    class="rounded-circle border border-2 border-white bg-primary btn-sm-square text-white position-absolute"
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="row g-4 align-items-center features-item">
                        <div class="col-4">
                            <div class="rounded-circle position-relative">
                                <div class="overflow-hidden rounded-circle">
                                    <img src="{{ asset('client/img/features-fashion.jpg') }}"
                                        class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                </div>
                                <span
                                    class="rounded-circle border border-2 border-white bg-primary btn-sm-square text-white position-absolute"
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="row g-4 align-items-center features-item">
                        <div class="col-4">
                            <div class="rounded-circle position-relative">
                                <div class="overflow-hidden rounded-circle">
                                    <img src="{{ asset('client/img/features-life-style.jpg') }}"
                                        class="img-zoomin img-fluid rounded-circle w-100" alt="">
                                </div>
                                <span
                                    class="rounded-circle border border-2 border-white bg-primary btn-sm-square text-white position-absolute"
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7 col-xl-8 mt-0">
                    <div class="position-relative overflow-hidden rounded">
                        <img src="{{ $firstPost->img }}" class="img-fluid rounded img-zoomin w-100" alt="">
                        <div class="d-flex justify-content-center px-4 position-absolute flex-wrap" style="bottom: 10px; left: 0;">
                            <a href="#" class="text-white me-3 link-hover">
                                <i class="fa fa-clock"></i> {{ \Carbon\Carbon::parse($firstPost->created_at)->diffForHumans() }}
                            </a>
                            <a href="#" class="text-white me-3 link-hover">
                                <i class="fa fa-eye"></i> {{ $firstPost->views >= 1000 ? number_format($firstPost->views / 1000, 1) . 'k' : $firstPost->views }}
                            </a>
                        </div>
                    </div>
                    <div class="border-bottom py-3">
                        <a href="{{ url('/detail/' . $firstPost->id) }}" class="display-4 text-dark mb-0 link-hover">{{ $firstPost->title }}</a>
                    </div>
                    <p class="mt-3 mb-4">{{ Str::limit($firstPost->content, 100) }}</p>
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-md-6">
                                    <div class="rounded overflow-hidden">
                                        <img src="{{ $topStory->img }}" class="img-fluid rounded img-zoomin w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-flex flex-column">
                                        <a href="{{ url('/detail/' . $topStory->id) }}" class="h3">{{ $topStory->title }}</a>
                                        <p class="mb-0 fs-5"><i class="fa fa-clock"></i> {{ \Carbon\Carbon::parse($topStory->created_at)->diffForHumans() }}</p>
                                        <p class="mb-0 fs-5"><i class="fa fa-eye"></i> {{ $topStory->views >= 1000 ? number_format($topStory->views / 1000, 1) . 'k' : $topStory->views }}</p>
                                    </div>
                                </div>
                            </div>
                        @else
                    ...
                    <div class="bg-light rounded p-4 pt-0">
                        <div class="row g-4">
                            @foreach($latestPosts as $index => $post)
                                @if($index == 0)
                                    <!-- First latest post (larger) -->
                                    <div class="col-12">
                                        <div class="rounded overflow-hidden">
                                            <img src="{{ $post->img }}" class="img-fluid rounded img-zoomin w-100" alt="">
                                        </div>
                                        <div class="d-flex flex-column mt-3">
                                            <a href="{{ url('/detail/' . $post->id) }}" class="h4 mb-2">{{ $post->title }}</a>
                                            <p class="fs-5 mb-0">
                                                <i class="fa fa-clock"></i> {{ \Carbon\Carbon::parse($post->created_at)->diffForHumans() }}
                                            </p>
                                            <p class="fs-5 mb-0">
                                        ...
                                        <div class="row g-4 align-items-center">
                                            <div class="col-5">
                                                <div class="overflow-hidden rounded">
                                                    <img src="{{ $post->img }}" class="img-zoomin img-fluid rounded w-100" alt="">
                                                </div>
                                            </div>
                                            <div class="col-7">
                                                <div class="features-content d-flex flex-column">
                                                    <a href="{{ url('/detail/' . $post->id) }}" class="h6">{{ $post->title }}</a>
                                                    <small><i class="fa fa-clock"></i> {{ \Carbon\Carbon::parse($post->created_at)->diffForHumans() }}</small>
                                                    <small><i class="fa fa-eye"></i> {{ $post->views }} Views</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid py-5 my-5"
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="rounded">
                        <img src="{{ asset('client/img/banner-img.jpg') }}" class="img-fluid rounded w-100 rounded"
                            alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="latest-news-carousel owl-carousel">
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="{{ asset('client/img/news-7.jpg') }}"
                ...
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="{{ asset('client/img/news-6.jpg') }}"
                                class="img-zoomin img-fluid rounded-top w-100" alt="">
                        </div>
                        <div class="d-flex flex-column p-4">
                            <a href="#" class="h4">Lorem Ipsum is simply dummy text of...</a>
                ...
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="{{ asset('client/img/news-3.jpg') }}"
                                class="img-zoomin img-fluid rounded-top w-100" alt="">
                        </div>
                        <div class="d-flex flex-column p-4">
                            <a href="#" class="h4">Lorem Ipsum is simply dummy text of...</a>
                ...
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="{{ asset('client/img/news-4.jpg') }}"
                                class="img-zoomin img-fluid rounded-top w-100" alt="">
                        </div>
                        <div class="d-flex flex-column p-4">
                            <a href="#" class="h4">Lorem Ipsum is simply dummy text of...</a>
                ...
                <div class="latest-news-item">
                    <div class="bg-light rounded">
                        <div class="rounded-top overflow-hidden">
                            <img src="{{ asset('client/img/news-5.jpg') }}"
                                class="img-zoomin img-fluid rounded-top w-100" alt="">
                        </div>
                        <div class="d-flex flex-column p-4">
                            <a href="#" class="h4 ">Lorem Ipsum is simply dummy text of...</a>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-8">
                                        <div class="position-relative rounded overflow-hidden">
                                            <img src="{{ asset('client/img/news-1.jpg') }}"
                        ...
                        <div class="whats-carousel owl-carousel">
                            <div class="latest-news-item">
                                <div class="bg-light rounded">
                                    ...
                                    <div class="d-flex flex-column p-4">
                                        <a href="#" class="h4">There are many variations of passages of Lorem
                                            Ipsum available,</a>
                                        <div class="d-flex justify-content-between">
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="lifestyle-item rounded">
                                        <img src="{{ asset('client/img/lifestyle-1.jpg') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="lifestyle-item rounded">
                                        <img src="{{ asset('client/img/lifestyle-2.jpg') }}"
                                            class="img-fluid w-100 rounded" alt="">
                                        <div class="lifestyle-content">
                                            <div class="mt-auto">
                                                <a href="#" class="h4 text-white link-hover">There are many
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="position-relative banner-2">
                                                <img src="{{ asset('client/img/banner-2.jpg') }}"
                                                    class="img-fluid w-100 rounded" alt="">
